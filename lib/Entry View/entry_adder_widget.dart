...
class EntryAdderWidget extends StatefulWidget {
  ...
  const EntryAdderWidget({super.key});

  @override
  State<StatefulWidget> createState() {
    return _EntryAdderWidgetState();
  }

}

class _EntryAdderWidgetState extends State<EntryAdderWidget>{

  EntryAdderModel model = EntryAdderModel();
